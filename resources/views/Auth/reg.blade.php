  ...
  @endif
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  @csrf
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                       <i class="fas fa-photo-video  me-3 fa-fw "></i>

                      <div class="form-outline flex-fill mb-0">
                        <input name="avatar"  type="file" id="form3Example4c" class="form-control" placeholder="image" />
                       </div>
                    </div>
                    <div class="d-flex flex-row align-items-center mb-4">
                       <i class="fab fa-facebook fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <input name="facebook"  type="email" id="form3Example4c" class="form-control" placeholder="facebook" />
                       </div>
                    </div>
                    <div class="d-flex flex-row align-items-center mb-4">
                       <i class="fab fa-youtube  fa-lg me-3 fa-fw "></i>
                      <div class="form-outline flex-fill mb-0">
                        <input name="youtube"  type="email" id="form3Example4c" class="form-control" placeholder="youtube" />
                       </div>
                    </div>
